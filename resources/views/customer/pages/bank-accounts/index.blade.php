                ...
                <div class="col-12">
                                                ...
                                                <form action="{{ route('bank-accounts.update', $account->id) }}"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select name="bank_account_type" id="bank_account_type">
                                                                <option value="current_account"
                                                                    @if ($account->account_type == 'current_account') selected @endif>
                                                                    Current Account</option>
                                                                <option value="savings_account"
                                                                    @if ($account->account_type == 'savings_account') selected @endif>
                                                                    Savings Account</option>
                                                                <option value="isa_account"
                                                                    @if ($account->account_type == 'isa_account') selected @endif>ISA
                                                                    Account</option>
                                                                <option value="investment_account"
                                                                    @if ($account->account_type == 'investment_account') selected @endif>
                                                                    Investment Account</option>
                                                                <option value="pension"
                                                                    @if ($account->account_type == 'pension') selected @endif>
                                                                    Pension</option>
                                                                <option value="investment"
                                                                    @if ($account->account_type == 'investment') selected @endif>
                                                                    Investments</option>
                                                                <option value="credit_card"
                                                                    @if ($account->account_type == 'credit_card') selected @endif>Credit
                                                                    Card</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="number" name="bank_account_starting_balance"
                                                                id="bank_account_starting_balance"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 offset-md-8 d-md-flex justify-content-md-end">
                                                            <button type="submit"
                                                                class="twoToneBlueGreenBtn text-center py-2">Update</button>
                                                        </div>
                                                    </div>
                                                </form>
                    ...
                    @else
                        <div class="noAccountNotice text-center">
                            ...
                            <p>
                                Add each of your bank accounts so you can easily keep track of all your spending and current
                                balances.
                            </p>
                            <button type="button" class="twoToneBlueGreenBtn" data-bs-toggle="modal"
                                data-bs-target="#addBankAccountModal">
