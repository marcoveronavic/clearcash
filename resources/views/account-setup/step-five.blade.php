    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function confirmMoveSalary(){
                const text = 'Hai già selezionato un conto stipendio. Vuoi spostare lo stipendio su questo conto?';
                if (window.Swal && typeof window.Swal.fire === 'function') {
                    return Swal.fire({ icon: 'warning', title: 'Spostare il conto stipendio?', text: text, showCancelButton: true, confirmButtonText: 'Sì', cancelButtonText: 'No' }).then(r => !!r.isConfirmed);
                }
            ...
            function createEditableItem(existingValues = null){
                ...
                bankItem.innerHTML = `
                    ...
                    <div class="row mt-3"><div class="col-12">
                        <label class="salaryRowLabel"><input type="checkbox" name="is_salary_account[]" value="1"><span>Questo è il conto dove ricevo lo stipendio</span></label>
                        <div class="salaryHint">Solo un conto può essere impostato come conto stipendio.</div>
                    </div></div>
