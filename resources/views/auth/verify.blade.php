                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card emailVerifyCard">
                        <div class="card-header">
                            ...
                            <p>
                                You're almost there!  We've just sent an email to  {{ Auth::user()->email }}.
                            </p>
                            <p>
                                Click the link in that email to verify your email address and complete your signup.  If you don't see it, please check your span folder.
                            </p>
